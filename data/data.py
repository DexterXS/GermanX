...
prepositions = {
            ...
            "dat": ['ab (прочь, away)', 'außer (кроме, except)', 'zu (к, to)', 'nach (после, after)', 'bei (в, at)', 'von (от, from)', 'aus (снаружи, out of)', 'mit (с, with)', 'seit (с, from)', 'gegenüber (противоположный, opposite)']
        }
